function findTopLeft(pointList) { // Max Lat Min long
	var maxLat = null;
	var minLon = null;
...
function findTopRight(pointList) { // Max Lat Max long
	var maxLat = null;
	var maxLon = null;
...
function findBottomLeft(pointList) { // Min Lat Min long
	var minLat = null;
	var minLon = null;
...
function findBottomRight(pointList) { // Min Lat Max long
	var minLat = null;
	var maxLon = null;
...
function Run(){
	...
	console.log("Bounding box computed for renpor7@tamu.edu: ");
